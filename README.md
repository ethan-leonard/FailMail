...
--- 
*This project skeleton was generated by an AI assistant based on a detailed prompt.* Remember to replace placeholders like `YOUR_WEB_APPLICATION_CLIENT_ID_HERE` with your actual values. 